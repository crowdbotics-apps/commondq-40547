"""
Django settings for commondq_40547 project.
...
ROOT_URLCONF = 'commondq_40547.urls'
...
WSGI_APPLICATION = 'commondq_40547.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "commondq_40547 API",
    "DESCRIPTION": "API documentation for commondq_40547 App",
    "VERSION": "v1",
}
